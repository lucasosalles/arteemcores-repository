        ...
        <div className="p-6 border-b border-border">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full gradient-gold flex items-center justify-center">
              <Paintbrush className="w-5 h-5 text-secondary-foreground" />
            </div>
            <span className="font-extrabold text-gradient-gold text-lg">ARTE EM CORES</span>
          </div>
        </div>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-card border-b border-border px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full gradient-gold flex items-center justify-center">
            <Paintbrush className="w-4 h-4 text-secondary-foreground" />
          </div>
          <span className="font-extrabold text-gradient-gold text-sm">ARTE EM CORES</span>
        </div>
        <div className="flex items-center gap-2">
